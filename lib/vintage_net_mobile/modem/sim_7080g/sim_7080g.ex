defmodule VintageNetMobile.Modem.SIM7080G do
  ...
  ```elixir
    config :vintage_net, power_managers: [{VintageNetMobile.Modem.SIM7080G.Modeswitch, ifname: "ppp0"}]
  ```
  ...
  ```elixir
    VintageNet.configure("ppp0", %{
      ...
      vintage_net_mobile: %{
        modem: VintageNetMobile.Modem.SIM7080G,
